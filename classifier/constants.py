...
_output_model_dir = os.path.join(_parent_dir, "output")
...
MODEL_NAMES = [
    # "seyonec/ChemBERTa-zinc-base-v1",  - full ds 2d-mrl-embed preferred in init. hyperparam. search then QED_morgan (NON-functional)
    os.path.join(
        _output_model_dir,
