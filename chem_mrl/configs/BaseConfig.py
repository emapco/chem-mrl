...
class BaseConfig:
    ...
    def __post_init__(self):
        ...
        if (
            not isinstance(self.test_dataset_path, str)
            and self.test_dataset_path is not None
        ):
            raise TypeError("test_dataset_path must be a string or None")
        if (
            not isinstance(self.num_train_samples, int)
            and self.num_train_samples is not None
        ):
            raise TypeError("num_train_samples must be an integer or None")
        if (
            not isinstance(self.num_val_samples, int)
            and self.num_val_samples is not None
        ):
            raise TypeError("num_val_samples must be an integer or None")
        if (
            not isinstance(self.num_test_samples, int)
            and self.num_test_samples is not None
        ):
            raise TypeError("num_test_samples must be an integer or None")
        ...
        if self.test_dataset_path is not None:
            raise NotImplementedError("test_dataset_path is not implemented yet")
        ...
        if self.num_train_samples is not None and self.num_train_samples <= 0:
            raise ValueError("if specified, num_train_samples must be greater than 0")
        if self.num_val_samples is not None and self.num_val_samples <= 0:
            raise ValueError("if specified, num_val_samples must be greater than 0")
        if self.num_test_samples is not None:
            raise NotImplementedError("num_test_samples is not implemented yet")
